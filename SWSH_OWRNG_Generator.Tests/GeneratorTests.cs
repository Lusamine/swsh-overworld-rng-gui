...
public sealed class GeneratorTests
{
    ...
    public void GenerateStatic(in ulong s0, in ulong s1)
    {
        ...
        List<Frame> Frames = Static.Generate(s0, s1, 1000, 0, Progress, Filters, 0, 14);
    ...
    public void GenerateSymbol(in ulong s0, in ulong s1)
    {
        ...
        Frames.Where(f => f.PID == "4ED54E82" && f.EC == "5C7EDFDF" && uint.Parse(f.Slot) == 94 && f.Level == 36 && f.HP == 31 && f.Atk == 31 && f.Def == 11 && f.SpA == 11 && f.SpD == 21 && f.Spe == 21 && f.Mark == "Peeved").Count().Should().Be(1);
